...
def hf_bucket_url(
  ...
  if hf_endpoint_env:
    # 如果 HF_ENDPOINT 环境变量存在，则使用它作为基础 URL
    endpoint = hf_endpoint_env
    if revision is None:
        revision = "main" # 默认 revision
    print(f"DEBUG: Final URL generated by hf_bucket_url: {endpoint}/{model_id}/resolve/{revision}/{filename}")
